  ...
  return (
    <footer className="bg-gray-900 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-gray-400 text-sm mb-4 md:mb-0 text-center w-full py-5">
              <p>&copy; {currentYear} MyPeerCloud. All rights reserved.</p>
              <p className="mt-1 text-xs text-gray-500">
                Owned and operated by <span className="font-medium text-gray-300">Muhammad Abubakar</span>
              </p>
            </div>
      </div>
    </footer>
