  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700 p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <a href="tel:+911234567890" className="text-green-400 hover:text-green-300 transition-colors">
                    +91 123 456 7890
                  </a>
                  <p className="text-sm text-gray-400 mt-1">Mon-Fri, 9 AM - 6 PM IST</p>
                </div>
              </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-700">
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="w-10 h-10 bg-gray-700 rounded-lg flex items-center justify-center hover:bg-pink-600 transition-colors">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" className="w-10 h-10 bg-gray-700 rounded-lg flex items-center justify-center hover:bg-blue-700 transition-colors">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700 p-8">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-gray-900 font-semibold rounded-lg transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
              >
                Send Message
              </button>
            </form>
        ...
        <div className="mt-8 bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700 p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-gray-300">
            ...
            <div>
              ...
              <p>U72900KA2024PTC123456</p>
            </div>
            <div>
              <h3 className="font-semibold text-white mb-2">GST Number</h3>
              <p>29AABCS1234F1Z5</p>
            </div>
          </div>
        </div>
