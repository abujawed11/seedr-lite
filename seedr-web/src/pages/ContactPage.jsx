            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <a href="mailto:support@mypeercloud.in" className="text-blue-400 hover:text-blue-300 transition-colors">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-semibold text-white mb-1">Support Availability</h3>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700 p-8">
            ...
            <div className="mt-6 p-4 bg-blue-900/20 border border-blue-700/50 rounded-lg">
              <p className="text-sm text-blue-300">
                <strong>Quick Response:</strong> For urgent issues, please email us directly at support@mypeercloud.in or call our support line.
              </p>
            </div>
          </div>
        </div>
