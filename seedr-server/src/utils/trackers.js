...
const BASE_TRACKERS = [
    ...
    'http://tracker.valete.tf:9999/announce',
    ...
    // room to grow; add more as you like:
    ...
    // 'https://tracker.pirateparty.red:443/announce',
    // 'udp://tracker.internetwarriors.net:1337/announce',
];

function getTrackers(extra = []) {
  // Merge base + extra and remove duplicates
  return Array.from(new Set([...BASE_TRACKERS, ...extra])).filter(Boolean);
}
